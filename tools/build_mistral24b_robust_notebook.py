...
OUT = Path("/Users/raresolteanu/Desktop/Gliner-Work.Dauphine/model one per model/mistral_small_24b__single_model_dimension_pipeline_robust.ipynb")
...
set_cell_source(
    nb,
    0,
    """# Mistral Small 24B Single-Model Pipeline, Robust Batched Version

This version mirrors the robust Llama notebooks so results stay directly comparable.
It keeps:
...
# This notebook is configured for a 2-GPU Mistral Small 24B run.
