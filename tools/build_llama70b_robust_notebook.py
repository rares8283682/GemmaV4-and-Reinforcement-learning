...
OUT = Path("/Users/raresolteanu/Desktop/Gliner-Work.Dauphine/model one per model/llama_3_1_70b__single_model_dimension_pipeline_robust.ipynb")
...
set_cell_source(
    nb,
    0,
    """# Llama 3.1 70B Single-Model Pipeline, Robust Batched Version

This version mirrors the robust Llama 8B notebook so results stay directly comparable.
It keeps:
