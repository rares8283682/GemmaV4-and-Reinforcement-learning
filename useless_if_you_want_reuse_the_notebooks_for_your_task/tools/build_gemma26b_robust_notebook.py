...
OUT = Path("/Users/raresolteanu/Desktop/Gliner-Work.Dauphine/model one per model/gemma_4_26b__single_model_dimension_pipeline_robust.ipynb")
...
set_cell_source(
    nb,
    0,
    """# Gemma 4 26B Single-Model Pipeline, Robust Batched Version

This version mirrors the robust Llama and Mistral notebooks so results stay directly comparable.
It keeps:
...
# This notebook is configured for a 2-GPU Gemma 4 26B run.
